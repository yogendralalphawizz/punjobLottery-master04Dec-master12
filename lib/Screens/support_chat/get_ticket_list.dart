                ...
                child: Padding(
                  ...
                  child: Card(
                    child: ListTile(title: Text("${getTicketsModel.data?[index].description}"),
                      ...
                      trailing:"${getTicketsModel.data?[index].msg}"=="colse"?
                      Container(
                     ...
                     child:   Text("Close",style: TextStyle(color: Colors.white,fontSize: 12),)
                      ):"${getTicketsModel.data?[index].msg}"=="reopen"?
                      Container(
                          padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                          decoration: BoxDecoration(
                              color: Colors.green,
                          ...
                          child:   Text("Reopen",style: TextStyle(color: Colors.white,fontSize: 12),)
                      ):

                      "${getTicketsModel.data?[index].msg}"=="open"?
                      Container(
                          padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                          decoration: BoxDecoration(
                              color: Colors.green,
                      ...
                      ): "${getTicketsModel.data?[index].msg}"=="Pending"?
                      ...
                      Container(
                          ...
                          child:   Text("Resolve",style: TextStyle(color: Colors.white,fontSize: 12),)
                      )
