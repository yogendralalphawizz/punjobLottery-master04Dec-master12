...
class _AddticketScreenScreenState extends State<AddticketScreen> {
            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButton<dynamic>(
                  ...
                  items: getTicketsModel?.data?.map((value) {
              ...
              AppButton(
                ...
                onTap: () async {
                  ...
                  if (subjController.text == "") {
                    Fluttertoast.showToast(
                        msg: " Subject Feild Required",
                        backgroundColor: AppColors.fntClr);
                    return;
                  }
                  if (descriptionController.text == "") {
                    Fluttertoast.showToast(
                        msg: "Description Feild Required",
                        backgroundColor: AppColors.fntClr);
                    return;
                  }
  ...
  updateProfile() async {
    ...
    final response =
        await http.post(Uri.parse('${baseUrl}add_ticket_post'), body: body);
