...
class _WithdrawalScreenState extends State<WithdrawalScreen> {
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            ...
                            return 'Please enter minimum 11 digit  number';
                          }
                          return null;
                        },
                      ),
   ...
   return  getTransactionModel == null? Center(child: CircularProgressIndicator()) : getTransactionModel!.withdrawdata!.isEmpty?  Center(child: Text("No Withdrawal List Found!!")):Container(
     ...
     child: ListView.builder(
         ...
         itemBuilder: (context,i){
           print( getTransactionModel?.withdrawdata?[i].requestStatus);
           return Card(
             child: Padding(
               padding: const EdgeInsets.all(8.0),
               child: Padding(
                 ...
                 child: Column(
                   ...
                   children: [
                    // getTransactionModel?.withdrawdata?[i].acHolderName == ""?
                     Row(
                       ...
                       children: [
                         ...
                         getTransactionModel?.withdrawdata?[i].requestStatus=="2"?
                         Container(
                             padding: EdgeInsets.symmetric(horizontal: 10,vertical: 3),
                    ...
                    SizedBox(height: 3,),
                    Text("Request No.${getTransactionModel?.withdrawdata?[i].requestNumber}"),
                     SizedBox(height: 3,),
  ...
  getWithdrawApi() async {
    ...
    var body={
      ...
      "google_pay_number": selectedOption == 'UPI' ? upiController.text  :"",
