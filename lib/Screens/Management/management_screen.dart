...
class _ManagementScreenState extends State<ManagementScreen> {
  ...
  getWithdrawalblance() async {
    ...
    print(body);
    final response = await http.post(
        Uri.parse('${baseUrl}api_withdrawal_amount'),
        body: jsonEncode(body));
                                  ...
                                  children: [
                                    Text("ReferralCode : ",
                                        style: TextStyle(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    Text(
                                        "${getProfileModel?.profile?.referralCode ?? ""}"),
                                  ],
                                ),
                                // Row(
                                //   children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Divider(
                                    indent: 20, endIndent: 20, thickness: 2),
                                SizedBox(
                                  height: 10,
                                ),
                                Material(
                    ...
                    InkWell(
                        onTap: () {
                          if (selectoption == null) {
                            Fluttertoast.showToast(
                                msg: "Please Select Income Mapping",
                                backgroundColor: AppColors.fntClr);
                            return;
                          }
                          selectoptionupdate(
                              selectoption == "Deposit" ? "2" : "1");
                        },
                      ...
                      children: [
                        Expanded(
                          ...
                          child: InkWell(
                              ...
                              child: buildContainer("All Transaction ")),
                        ),
                        const SizedBox(
                          width: 10,
                        ),
