                              ...
                              Expanded(
                                ...
                                padding: EdgeInsets.symmetric(horizontal: 5,vertical: 5),
                                  decoration: BoxDecoration(
                                    color:"${taskboardListModel.data?[index].msg??"0"}"=="Complete"? Colors.green:"${taskboardListModel.data?[index].msg??"0"}"=="Running"?Colors.red.withOpacity(0.5):"${taskboardListModel.data?[index].msg??"0"}"=="Closed"?Colors.red:Colors.transparent,
                                    borderRadius: BorderRadius.circular(10)
                                  ),
                                  child: Center(child: Text("${taskboardListModel.data?[index].msg??"0"}",style: TextStyle(color: AppColors.whit,fontSize: 14,fontWeight: FontWeight.bold)))))
