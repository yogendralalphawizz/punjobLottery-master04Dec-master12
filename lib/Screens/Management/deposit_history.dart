                ...
                return Card(
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        Text("${widget.getAllDepositBalanceModel.data?.depositHistory?[index].insertDate}"),
                   Text("${widget.getAllDepositBalanceModel.data?.depositHistory?[index].transactionNote}"),
                      ],
                    ),
                    ...
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: 5,vertical: 2),
                        ...
                        child: Text("Sucess",style: TextStyle(color: Colors.white),)):Container(child: Text("Debit"))
